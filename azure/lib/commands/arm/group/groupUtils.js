...
function createDeploymentParameters(cli, subscription, resourceGroup, options, _) { var templateOptions, templateOptionsProvided, deploymentParameters, jsonFile, log, paramsRequired, templateParameters; var __frame = { name: "createDeploymentParameters", line: 213 }; return __func(_, this, arguments, createDeploymentParameters, 4, __frame, function __$createDeploymentParameters() {
    ...
    if ((options.parameters && options.parametersFile)) {
      ...
      return cli.interaction.withProgress($("Initializing template configurations and parameters"), function __2(log, _) { var templateUri, templateContent; var __frame = { name: "__2", line: 259 }; return __func(_, this, arguments, __2, 1, __frame, function __$__2() {
          ...
          templateUri = options.templateUri; return (function __$__2(__then) {
            ...
            if (deploymentParameters) {
              templateParameters.properties.parameters = deploymentParameters; } ; _(); }); }); }, __cb(_, __frame, 45, 18, function __$createDeploymentParameters() {
...
function getTemplateContent(subscription, templateFile, _) { var templateFileUri, content;
  function readTemplateFileContentFromUri(templateFileUri, callback) {
    request(templateFileUri, function(error, response, body) {
      callback(error, body); }); }; var __frame = { name: "getTemplateContent", line: 307 }; return __func(_, this, arguments, getTemplateContent, 2, __frame, function __$getTemplateContent() {
...
function getTemplateParams(cli, subscription, options, _) { var templateContent, paramKeys; var __frame = { name: "getTemplateParams", line: 331 }; return __func(_, this, arguments, getTemplateParams, 3, __frame, function __$getTemplateParams() { return (function __$getTemplateParams(_) {
      ...
      var __2 = options.templateFile; return (function __$getTemplateParams(__then) { if (__2) {
        ...
        return getTemplateContent(subscription, options.templateUri, __cb(_, __frame, 4, 4, _, true)); }); })(__cb(_, __frame, -330, 17, function ___(__0, __3) { templateContent = __3;
...
function getFailedNestedOperations(client, resourceGroup, currentOperations, _) { var newOperations; var __frame = { name: "getFailedNestedOperations", line: 368 }; return __func(_, this, arguments, getFailedNestedOperations, 3, __frame, function __$getFailedNestedOperations() {
    newOperations = [];
    return currentOperations.forEach_(__cb(_, __frame, 2, 20, function __$getFailedNestedOperations() {
      ...
      return _(null, newOperations); }, true), 1, function __1(_, operation) { var nestedDeployment, nestedOperations, newNestedOperations; var __frame = { name: "__1", line: 370 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return (function __$__1(__then) { if ((operation.properties.provisioningState === "Failed")) { newOperations.push(operation); return (function __$__1(__then) { if ((operation.properties.targetResource && (operation.properties.targetResource.id.indexOf("Microsoft.Resources/deployments") !== -1))) { nestedDeployment = operation.properties.targetResource.resourceName; return client.deploymentOperations.list(resourceGroup, nestedDeployment, __cb(_, __frame, 6, 59, function ___(__0, __1) { nestedOperations = __1.operations; return getFailedNestedOperations(client, resourceGroup, nestedOperations, __cb(_, __frame, 7, 34, function ___(__0, __2) { newNestedOperations = __2; newOperations.concat(newNestedOperations); __then(); }, true)); }, true)); } else { __then(); } ; })(__then); } else { __then(); } ; })(_); }); }); });};
