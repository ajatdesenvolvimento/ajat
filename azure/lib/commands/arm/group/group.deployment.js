...
exports.init = function(cli) {
            ...
            client = utils.createResourceClient(subscription); return (function __$__1(__then) {
              ...
              if (!options.nowait) {
                return cli.interaction.withProgress($("Waiting for deployment to complete"), function __1(log, _) { var failedOperations; var __frame = { name: "__1", line: 68 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() { var __1 = true; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__1() { __more = false;
                        ...
                        var __4 = (__1 || ((deployment.properties.provisioningState === "Running") || (deployment.properties.provisioningState === "Accepted"))); if (__4) { __1 = false; return client.deployments.get(resourceGroup, deployment.name, __cb(_, __frame, 2, 44, function ___(__0, __2) { deployment = __2.deployment; return setTimeout(__cb(_, __frame, 3, 12, function __$__1() { while (__more) { __loop(); }; __more = true; }, true), 5000); }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$__1() { return (function __$__1(__then) {
  ...
  deployment.command("stop [resource-group] [name]").usage("[options] <resource-group> [deployment-name]").description($("Stops a deployment")).option("-g --resource-group <resourceGroup>", $("the name of the resource group")).option("-q --quiet", $("quiet mode (do not ask for stop deployment confirmation)")).option("-n --name <name>", $("the name of the deployment (if not specified, the currently running deployment is stopped)")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, name, options, _) { var subscription, client, deploymentToStop, progress; var __frame = { name: "__4", line: 182 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
      ...
      deploymentToStop = name; return (function __$__4(__then) {
        ...
        if (!name) {
          return cli.interaction.withProgress($("Looking for \"Running\" or \"Accepted\" deployment"), function __1(log, _) { var allRunningDeployments, allAcceptedDeployments, allCancellableDeployments; var __frame = { name: "__1", line: 192 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
          ...
          if (deploymentToStop) { return (function __$__4(_) {
              ...
              return cli.interaction.confirm(util.format($("Stop deployment %s? [y/n]: "), deploymentToStop), __cb(_, __frame, 37, 29, function ___(__0, __4) { var __3 = !__4; return _(null, __3); }, true)); })(__cb(_, __frame, -181, 17, function ___(__0, __3) { return (function __$__4(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$__4() {
...
function retrieveDeployments(client, resourceGroup, state, _) { var parameters, response, allDeployments, nextLink; var __frame = { name: "retrieveDeployments", line: 269 }; return __func(_, this, arguments, retrieveDeployments, 3, __frame, function __$retrieveDeployments() {
    parameters = { };
    if (state) {
