...
__.extend(VMProfile.prototype, {
            ...
            return vmAvailSetProfile.generateAvailabilitySetProfile(__cb(_, __frame, 24, 50, function ___(__0, __4) { availsetProfileResult = __4;
              ...
              return vmNetworkProfile.generateNetworkProfile(__cb(_, __frame, 28, 48, function ___(__0, __5) { networkProfileResult = __5;
                ...
                if ((__this.params.tags && (typeof __this.params.tags === "string"))) {
                  ...
                  vmProfile.tags = __this._parseTags(vmProfile.tags, __this.params.tags); } ; return (function __$generateVMProfile__1(__then) {
                  ...
                  if ((((__this.params.disableBootDiagnostics !== null) || (__this.params.enableBootDiagnostics !== null)) || (__this.params.bootDiagnosticsStorageUri !== null))) { return (function __$generateVMProfile__1(__then) {
                      if ((__this.params.enableBootDiagnostics && (__this.params.bootDiagnosticsStorageUri === null))) {
                        ...
                        stoProfile = null; return (function __$generateVMProfile__1(__then) {
                          ...
                          if ((stoInfo === null)) {
                            return vmStorageProfile._createStorageAccountIfRequired(__cb(_, __frame, 43, 37, function ___(__0, __6) { stoInfo = __6; __then(); }, true)); } else { __then(); } ; })(function __$generateVMProfile__1() {
                            ...
                            if ((((stoProfile !== null) && stoProfile.primaryEndpoints) && stoProfile.primaryEndpoints.blob)) {
                              ...
                              for (itemKey in storageUtil.AccountTypeForChanging) {
                                ...
                                if (!foundElem) {
                                  ...
                                  return vmStorageProfile._generateNewStorageAccountNameWithPrefix("", __cb(_, __frame, 64, 51, function ___(__0, __7) { bootStorageName = __7;
                                    createRequestProfile = {
                                      accountType: "Standard_LRS",
                                      name: bootStorageName,
                                      location: __this.params.location };

                                    return __this.serviceClients.storageManagementClient.storageAccounts.create(__this.resourceGroupName, bootStorageName, createRequestProfile, __cb(_, __frame, 70, 72, function __$generateVMProfile__1() {
                                      return vmStorageProfile._findStorageAccount(bootStorageName, __cb(_, __frame, 71, 50, function ___(__0, __8) { bootStoProfile = __8;
  ...
  updateVMProfile: function updateVMProfile__2(virtualMachine, _) { var vmNetworkProfile, validNICs, vmHardwareProfile, vmDiagnosticsProfile, diagnosticsProfileResult, __this = this; var __frame = { name: "updateVMProfile__2", line: 136 }; return __func(_, this, arguments, updateVMProfile__2, 1, __frame, function __$updateVMProfile__2() {
  ...
  _parseVMProfileParams: function _parseVMProfileParams__3(params, _) { var vmProfile, __this = this; var __frame = { name: "_parseVMProfileParams__3", line: 189 }; return __func(_, this, arguments, _parseVMProfileParams__3, 1, __frame, function __$_parseVMProfileParams__3() { return (function __$_parseVMProfileParams__3(__then) {
        if (!params.location) {
