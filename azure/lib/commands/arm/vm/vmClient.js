...
__.extend(VMClient.prototype, {
  createVM: function createVM__1(resourceGroupName, vmName, location, osType, options, _) { var subscription, params, serviceClients, virtualMachine, vmResult, vmProfile, vmCreateProfile, diagProfile, diagMessage, found, foundVersion, vmImage, publishers, key1, types, key2, versions, bgInfoParams, vmExtensionProfile, vmBgInfoExtension, __this = this; var __frame = { name: "createVM__1", line: 55 }; return __func(_, this, arguments, createVM__1, 5, __frame, function __$createVM__1() {
      ...
      return virtualMachine.getVM(resourceGroupName, params.vmName, __cb(_, __frame, 65, 34, function ___(__0, __5) { vmResult = __5;
        if (vmResult) {
        ...
        return vmProfile.generateVMProfile(__cb(_, __frame, 71, 36, function ___(__0, __6) { vmCreateProfile = __6;
          ...
          found = false;
          foundVersion = vmConstants.EXTENSIONS.BGINFO_VERSION; return (function __$createVM__1(__then) {
            if ((!params.disableBginfoExtension && (osType.toString().toLowerCase() == "windows"))) {

              vmImage = new VMImage(__this.cli, serviceClients);
              return vmImage.getVMImagePublisherList(location, __cb(_, __frame, 89, 31, function ___(__0, __7) { publishers = __7;
                var __1 = __forIn(publishers); var __2 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$createVM__1() { __more = false; var __13 = (__2 < __1.length); if (__13) { key1 = __1[__2++]; return (function __$createVM__1(__then) {
                        if ((publishers[key1].name === vmConstants.EXTENSIONS.BGINFO_PUBLISHER)) {
                          return vmImage.getVMExtensionImageTypeList(location, publishers[key1].name, __cb(_, __frame, 92, 30, function ___(__0, __8) { types = __8;
                            var __3 = __forIn(types); var __4 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$createVM__1() { __more = false; var __15 = (__4 < __3.length); if (__15) { key2 = __3[__4++]; return (function __$createVM__1(__then) {
                                    if ((types[key2].name === vmConstants.EXTENSIONS.BGINFO_NAME)) {
                                      return vmImage.getVMExtensionImageVersionList(location, publishers[key1].name, types[key2].name, __cb(_, __frame, 95, 37, function ___(__0, __9) { versions = __9;
            ...
            return virtualMachine.createOrUpdateVM(resourceGroupName, vmCreateProfile.profile, true, __cb(_, __frame, 108, 19, function __$createVM__1() { return (function __$createVM__1(__then) {
                ...
                if (found) {
                  ...
                  return virtualMachine.createOrUpdateVMExtension(resourceGroupName, params.vmName, vmBgInfoExtension.profile, true, __cb(_, __frame, 121, 21, __then, true)); } else { __then(); } ; })(_); }, true)); }); }, true)); }, true)); }); },



  quickCreateVM: function quickCreateVM__2(resourceGroupName, vmName, location, osType, imageUrn, adminUsername, adminPassword, options, _) { var subscription, removeAllSpace, hash, resourceNamePrefix, resourceName, params, serviceClients, response, rgList, found, index, rgParams, virtualMachine, vmResult, vmProfile, vmCreateProfile, __this = this; var __frame = { name: "quickCreateVM__2", line: 180 }; return __func(_, this, arguments, quickCreateVM__2, 8, __frame, function __$quickCreateVM__2() {
      subscription = profile.current.getSubscription(__this.subscription);
      ...
      return serviceClients.resourceManagementClient.resourceGroups.list({ }, __cb(_, __frame, 57, 74, function ___(__0, __1) { response = __1;
        rgList = response.resourceGroups;
        found = false;
        for (index in rgList) {
          if ((rgList[index].name === resourceGroupName)) {
            found = true; } ; }; return (function __$quickCreateVM__2(__then) {



          if ((found === false)) {
            rgParams = { location: location };
            return serviceClients.resourceManagementClient.resourceGroups.createOrUpdate(resourceGroupName, rgParams, __cb(_, __frame, 68, 61, __then, true)); } else { __then(); } ; })(function __$quickCreateVM__2() {


          virtualMachine = new VirtualMachine(__this.cli, serviceClients);
          return virtualMachine.getVM(resourceGroupName, params.vmName, __cb(_, __frame, 72, 34, function ___(__0, __2) { vmResult = __2;
            if (vmResult) {
              return _(new Error(util.format($("A virtual machine with name \"%s\" already exists in the resource group \"%s\""), vmResult.name, resourceGroupName))); } ;


            vmProfile = new VMProfile(__this.cli, resourceGroupName, params, serviceClients);
            return vmProfile.generateVMProfile(__cb(_, __frame, 78, 36, function ___(__0, __3) { vmCreateProfile = __3;
              return virtualMachine.createOrUpdateVM(resourceGroupName, vmCreateProfile.profile, true, __cb(_, __frame, 79, 19, function __$quickCreateVM__2() {

                return __this.showVM(resourceGroupName, params.vmName, { }, __cb(_, __frame, 81, 9, function __$quickCreateVM__2() { _(); }, true)); }, true)); }, true)); }, true)); }); }, true)); }); },


  showVM: function showVM__3(resourceGroupName, name, options, _) { var output, isJson, depth, subscription, serviceClients, dependencies, vmResult, virtualMachine, __this = this; var __frame = { name: "showVM__3", line: 264 }; return __func(_, this, arguments, showVM__3, 3, __frame, function __$showVM__3() {
      ...
      return dependencies.virtualMachine.getVMByNameExpanded(resourceGroupName, name, depth, { }, dependencies, __cb(_, __frame, 29, 47, function ___(__0, __1) { vmResult = __1; return (function __$showVM__3(__then) {
          if (vmResult) {
            virtualMachine = vmResult; return (function __$showVM__3(__then) {
              if (isJson) {
  ...
  listVM: function listVM__4(resourceGroupName, options, _) { var subscription, serviceClients, virtualMachine, vmsResult, output, __this = this; var __frame = { name: "listVM__4", line: 311 }; return __func(_, this, arguments, listVM__4, 2, __frame, function __$listVM__4() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  deleteVM: function deleteVM__5(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "deleteVM__5", line: 334 }; return __func(_, this, arguments, deleteVM__5, 3, __frame, function __$deleteVM__5() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __2) { vmResult = __2;
        if (!vmResult) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm(util.format($("Delete the virtual machine \"%s\"? [y/n] "), name), __cb(_, __frame, 10, 48, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -333, 17, function ___(__0, __3) { return (function __$deleteVM__5(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$deleteVM__5() {
  ...
  stopVM: function stopVM__6(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, output, __this = this; var __frame = { name: "stopVM__6", line: 351 }; return __func(_, this, arguments, stopVM__6, 3, __frame, function __$stopVM__6() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  restartVM: function restartVM__7(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "restartVM__7", line: 367 }; return __func(_, this, arguments, restartVM__7, 3, __frame, function __$restartVM__7() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  startVM: function startVM__8(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "startVM__8", line: 380 }; return __func(_, this, arguments, startVM__8, 3, __frame, function __$startVM__8() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  deallocateVM: function deallocateVM__9(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "deallocateVM__9", line: 393 }; return __func(_, this, arguments, deallocateVM__9, 3, __frame, function __$deallocateVM__9() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  captureVM: function captureVM__10(resourceGroupName, name, vhdNamePrefix, options, _) { var subscription, serviceClients, virtualMachine, vmResult, result, __this = this; var __frame = { name: "captureVM__10", line: 406 }; return __func(_, this, arguments, captureVM__10, 4, __frame, function __$captureVM__10() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  generalizeVM: function generalizeVM__11(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "generalizeVM__11", line: 434 }; return __func(_, this, arguments, generalizeVM__11, 3, __frame, function __$generalizeVM__11() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  getInstanceView: function getInstanceView__12(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, output, instanceViewResult, vmInstanceView, __this = this; var __frame = { name: "getInstanceView__12", line: 447 }; return __func(_, this, arguments, getInstanceView__12, 3, __frame, function __$getInstanceView__12() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      output = __this.cli.output;
  ...
  getSerialOutput: function getSerialOutput__13(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, output, instanceViewResult, vmResult, instanceView, consoleScreenshotBlobUri, serialConsoleLogBlobUri, result, storageClient, keys, blobService, content, ws, performStorageOperation, operation, storageOptions, maxLen, startPos, strlen, __this = this; var __frame = { name: "getSerialOutput__13", line: 468 }; return __func(_, this, arguments, getSerialOutput__13, 3, __frame, function __$getSerialOutput__13() {
      ...
      return virtualMachine.getInstanceView(resourceGroupName, name, __cb(_, __frame, 6, 44, function ___(__0, __2) { instanceViewResult = __2; return (function __$getSerialOutput__13(__then) {
          if (!instanceViewResult) {
            ...
            vmResult = instanceViewResult; return (function __$getSerialOutput__13(__then) {
              if (vmResult) {
                    ...
                    result = __this._getStorageAccountContainerAndBlobFromUri(serialConsoleLogBlobUri); return (function __$getSerialOutput__13(__then) {
                      if (((result.accountName && result.containerName) && result.blobName)) {
                        ...
                        return storageClient.storageAccounts.listKeys(resourceGroupName, result.accountName, __cb(_, __frame, 34, 53, function ___(__0, __3) { keys = __3;
                          blobService = azureStorage.createBlobService(result.accountName, keys.key1);
                          ...
                          storageOptions = __this._getStorageBlobOperationDefaultOption(); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getSerialOutput__13() {
                              ...
                              startPos = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$getSerialOutput__13() { __more = false;
                                  var __8 = (startPos < content.length); if (__8) { return (function __$getSerialOutput__13(_) {
                                      var __1 = (startPos > 0); if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm("Do you want to view more log?", __cb(_, __frame, 64, 56, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -467, 17, function ___(__0, __4) { return (function __$getSerialOutput__13(__then) { if (__4) { return __break(); } else { __then(); } ; })(function __$getSerialOutput__13() {
  ...
  resetVMAccess: function resetVMAccess__14(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, vmExtensionProfile, vmAccessExtension, __this = this; var __frame = { name: "resetVMAccess__14", line: 546 }; return __func(_, this, arguments, resetVMAccess__14, 3, __frame, function __$resetVMAccess__14() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  enableAemVM: function enableAemVM__16(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, aemExtensionUtil, vmResult, vmStorageAccounts, saProperties, storageAccountsResult, osDiskUri, i, dataDisk, dataDiskUri, vmStorageAccountNames, diagExtension, wadStorageAccountName, diagParams, progress, vmDiagExtensionProfile, aemParams, vmAEMExtensionProfile, vmAEMExtension, __this = this; var __frame = { name: "enableAemVM__16", line: 591 }; return __func(_, this, arguments, enableAemVM__16, 3, __frame, function __$enableAemVM__16() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 6, 34, function ___(__0, __2) { vmResult = __2;
        ...
        storageAccountsResult = null; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$enableAemVM__16() {

              return serviceClients.storageManagementClient.storageAccounts.list(__cb(_, __frame, 20, 85, function ___(__0, __3) { storageAccountsResult = __3; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$enableAemVM__16() {

                StorageUtil.endProgress(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$enableAemVM__16() {
            ...
            return aemExtensionUtil.getStorageAccountProperties(serviceClients, storageAccountsResult, osDiskUri.accountName, __cb(_, __frame, 26, 36, function ___(__0, __4) { saProperties = __4;
              ...
              i = 0; var __13 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$enableAemVM__16() { __more = false; if (__13) { i++; } else { __13 = true; } ; var __12 = (i < vmResult.storageProfile.dataDisks.length); if (__12) {
                    dataDisk = vmResult.storageProfile.dataDisks[i];
                    dataDiskUri = blobUtil.splitDestinationUri(dataDisk.virtualHardDisk.uri); return (function __$enableAemVM__16(__then) {
                      if (!vmStorageAccounts[dataDiskUri.accountName]) {
                        return aemExtensionUtil.getStorageAccountProperties(serviceClients, storageAccountsResult.storageAccounts, dataDiskUri.accountName, __cb(_, __frame, 34, 40, function ___(__0, __5) { saProperties = __5;
                          vmStorageAccounts[saProperties.name] = saProperties; __then(); }, true)); } else { __then(); } ; })(function __$enableAemVM__16() { while (__more) { __loop(); }; __more = true; }); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$enableAemVM__16() {




                vmStorageAccountNames = Object.keys(vmStorageAccounts);
                i = 0; var __16 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$enableAemVM__16() { __more = false; if (__16) { i++; } else { __16 = true; } ; var __15 = (i < vmStorageAccountNames.length); if (__15) {
                      vmStorageAccount = vmStorageAccounts[vmStorageAccountNames[i]]; return (function __$enableAemVM__16(__then) {
                        if ((vmStorageAccount.type === "Standard")) {
                          return aemExtensionUtil.enableStorageAccountAnalytics(vmStorageAccount, __cb(_, __frame, 44, 25, __then, true)); } else { __then(); } ; })(function __$enableAemVM__16() { while (__more) { __loop(); }; __more = true; }); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$enableAemVM__16() {




                  diagExtension = __.find(vmResult.extensions, function(extension) {
                    return (((extension.type === vmConstants.EXTENSIONS.IAAS_DIAG_NAME) && (extension.publisher === vmConstants.EXTENSIONS.IAAS_DIAG_PUBLISHER)) || ((extension.type === vmConstants.EXTENSIONS.LINUX_DIAG_NAME) && (extension.publisher === vmConstants.EXTENSIONS.LINUX_DIAG_PUBLISHER))); });



                  wadStorageAccountName = null; return (function __$enableAemVM__16(__then) {
                    if (!diagExtension) {
                      __this.cli.output.info(util.format($("Diagnostic extension must be enabled first for Virtual Machine \"%s\"."), name)); return (function __$enableAemVM__16(_) {
                        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm($("Install the virtual machine diagnostic extension? [y/n] "), __cb(_, __frame, 57, 50, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -590, 17, function ___(__0, __6) { return (function __$enableAemVM__16(__then) { if (__6) {
                            __this.cli.output.error($("Canceled. Please enable diagnostic extension first.")); return _(null); } else { __then(); } ; })(function __$enableAemVM__16() {
                          ...
                          progress = __this.cli.interaction.progress($("Preparing parameters for diagnostic extension")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$enableAemVM__16() {

                                vmDiagExtensionProfile = new VMExtensionProfile(__this.cli, diagParams, serviceClients);
                                return vmDiagExtensionProfile.generateVMDiagExtensionProfile(__cb(_, __frame, 91, 47, function ___(__0, __7) { diagExtension = __7.profile; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$enableAemVM__16() {

                                  progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$enableAemVM__16() {

                              return virtualMachine.createOrUpdateVMExtension(resourceGroupName, name, diagExtension, true, __cb(_, __frame, 95, 21, __then, true)); }); }); }); }, true)); } else { __then(); } ; })(function __$enableAemVM__16() {
                    ...
                    if (!wadStorageAccountName) {
                      ...
                      if (!options.diagnosticStorageAccountName) {
                        ...
                        __this.cli.output.error($("Please specify one with option -a, --diagnostic-storage-account-name")); return _(null); } ; } ; return (function __$enableAemVM__16(__then) {




                      if (!vmStorageAccounts[wadStorageAccountName]) {
                        return aemExtensionUtil.getStorageAccountProperties(serviceClients, storageAccountsResult.storageAccounts, wadStorageAccountName, __cb(_, __frame, 109, 38, function ___(__0, __8) { saProperties = __8;
                          vmStorageAccounts[saProperties.name] = saProperties; __then(); }, true)); } else { __then(); } ; })(function __$enableAemVM__16() {
                      ...
                      return virtualMachine.createOrUpdateVMExtension(resourceGroupName, name, vmAEMExtension.profile, true, __cb(_, __frame, 127, 19, function __$enableAemVM__16() { _(); }, true)); }); }); }); }); }, true)); }); }); }, true)); }); },


  setVM: function setVM__17(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, vmResult, vmProfile, __this = this; var __frame = { name: "setVM__17", line: 721 }; return __func(_, this, arguments, setVM__17, 3, __frame, function __$setVM__17() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 5, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return vmProfile.updateVMProfile(vmResult, __cb(_, __frame, 24, 25, function ___(__0, __2) { vmResult = __2;
          ...
          return virtualMachine.createOrUpdateVM(resourceGroupName, vmResult, false, __cb(_, __frame, 26, 19, function __$setVM__17() { _(); }, true)); }, true)); }, true)); }); },


  listVMSizesOrLocationVMSizes: function listVMSizesOrLocationVMSizes__18(options, _) { var subscription, serviceClients, virtualMachine, sizeResult, vmResult, output, __this = this; var __frame = { name: "listVMSizesOrLocationVMSizes__18", line: 750 }; return __func(_, this, arguments, listVMSizesOrLocationVMSizes__18, 1, __frame, function __$listVMSizesOrLocationVMSizes__18() {
      if ((options.location && options.vmName)) {
        return _(new Error($("Both --location and --vm-name parameters cannot be specified together."))); } ; return (function __$listVMSizesOrLocationVMSizes__18(__then) {


        if (options.vmName) { return (function __$listVMSizesOrLocationVMSizes__18(__then) {
          ...
          if (!options.location) {
            return _(new Error($("One of the optional parameter --location or --vm-name is required."))); } ; __then(); } ; })(function __$listVMSizesOrLocationVMSizes__18() {


        subscription = profile.current.getSubscription(__this.subscription);
        serviceClients = __this._getServiceClients(subscription);
        virtualMachine = new VirtualMachine(__this.cli, serviceClients); return (function __$listVMSizesOrLocationVMSizes__18(__then) {
          ...
          if (options.vmName) {
            ...
            return virtualMachine.getVMSizesByLocationName(options.location, __cb(_, __frame, 26, 34, function ___(__0, __4) { sizeResult = __4; __then(); }, true)); } ; })(function __$listVMSizesOrLocationVMSizes__18() {
  ...
  listComputeUsage: function listComputeUsage__19(location, options, _) { var subscription, client, usageResult, output, usages, __this = this; var __frame = { name: "listComputeUsage__19", line: 796 }; return __func(_, this, arguments, listComputeUsage__19, 2, __frame, function __$listComputeUsage__19() {
      subscription = profile.current.getSubscription(__this.subscription);
  ...
  attachNewDataDisk: function attachNewDataDisk__20(resourceGroup, vmName, size, vhdName, options, _) { var subscription, serviceClients, params, virtualMachine, vmResult, vmStorageProfile, newDataDisk, dataDisks, __this = this; var __frame = { name: "attachNewDataDisk__20", line: 823 }; return __func(_, this, arguments, attachNewDataDisk__20, 5, __frame, function __$attachNewDataDisk__20() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return virtualMachine.getVM(resourceGroup, vmName, __cb(_, __frame, 15, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return vmStorageProfile.generateDataDiskProfile(__cb(_, __frame, 28, 39, function ___(__0, __2) { newDataDisk = __2;
          ...
          dataDisks = (vmResult.storageProfile.dataDisks || []);
          dataDisks.push(newDataDisk); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$attachNewDataDisk__20() {


                return virtualMachine.createOrUpdateVM(resourceGroup, vmResult, false, __cb(_, __frame, 35, 21, __then, true)); }); })(function ___(err, __result) { __catch(function __$attachNewDataDisk__20() { if (err) {
                  ...
                  if (((err.code === "InvalidParameter") && (err.message === "The value of parameter 'dataDisk.lun' is invalid."))) {
                    ...
                    return _(err); } ; __then(); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$attachNewDataDisk__20() { _(); }); }); }, true)); }, true)); }); },




  attachDataDisk: function attachDataDisk__21(resourceGroup, vmName, vhdUrl, options, _) { var subscription, serviceClients, params, virtualMachine, vmResult, vmStorageProfile, newDataDisk, dataDisks, __this = this; var __frame = { name: "attachDataDisk__21", line: 868 }; return __func(_, this, arguments, attachDataDisk__21, 4, __frame, function __$attachDataDisk__21() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return virtualMachine.getVM(resourceGroup, vmName, __cb(_, __frame, 12, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return vmStorageProfile.generateDataDiskProfile(__cb(_, __frame, 19, 39, function ___(__0, __2) { newDataDisk = __2;
          ...
          dataDisks = (vmResult.storageProfile.dataDisks || []);
          dataDisks.push(newDataDisk); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$attachDataDisk__21() {


                return virtualMachine.createOrUpdateVM(resourceGroup, vmResult, false, __cb(_, __frame, 25, 21, __then, true)); }); })(function ___(err, __result) { __catch(function __$attachDataDisk__21() { if (err) {

                  if (((err.code === "InvalidParameter") && (err.message === "The value of parameter 'dataDisk.lun' is invalid."))) {
                    return _(new Error(util.format($("Exceeded the maximum number of data disks that can be attached to a VM with size \"%s\"."), vmResult.hardwareProfile.vmSize))); }
                   else {
                    return _(err); } ; __then(); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$attachDataDisk__21() { _(); }); }); }, true)); }, true)); }); },




  detachDataDisk: function detachDataDisk__22(resourceGroup, vmName, lun, options, _) { var subscription, serviceClients, lunAsInt, virtualMachine, vmResult, vmStorageProfile, __this = this; var __frame = { name: "detachDataDisk__22", line: 903 }; return __func(_, this, arguments, detachDataDisk__22, 4, __frame, function __$detachDataDisk__22() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return virtualMachine.getVM(resourceGroup, vmName, __cb(_, __frame, 10, 34, function ___(__0, __1) { vmResult = __1;
        ...
        return virtualMachine.createOrUpdateVM(resourceGroup, vmResult, false, __cb(_, __frame, 18, 19, function __$detachDataDisk__22() { _(); }, true)); }, true)); }); },


  listDataDisks: function listDataDisks__23(resourceGroup, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, dataDisks, output, __this = this; var __frame = { name: "listDataDisks__23", line: 924 }; return __func(_, this, arguments, listDataDisks__23, 3, __frame, function __$listDataDisks__23() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  setExtension: function setExtension__24(resourceGroupName, vmName, extensionName, publisherName, version, options, _) { var subscription, serviceClients, virtualMachine, vmResult, __this = this; var __frame = { name: "setExtension__24", line: 957 }; return __func(_, this, arguments, setExtension__24, 6, __frame, function __$setExtension__24() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      return virtualMachine.getVM(resourceGroupName, vmName, __cb(_, __frame, 4, 34, function ___(__0, __1) { vmResult = __1;
        ...
        if ((virtualMachine.storageProfile.osDisk.osType === "Windows")) {
          if ((!virtualMachine.osProfile.windowsConfiguration || !virtualMachine.osProfile.windowsConfiguration.provisionVMAgent)) {
            return _(new Error($("Provision Guest Agent must be enabled on the VM before setting VM Extension."))); } ; } ; return (function __$setExtension__24(__then) {



          if (options.uninstall) {
            return __this._uninstallExtension(resourceGroupName, vmName, extensionName, serviceClients, options, __cb(_, __frame, 17, 11, function __$setExtension__24() { return _(null); }, true)); } else { __then(); } ; })(function __$setExtension__24() {



          options.location = vmResult.location;
          return __this._createOrUpdateExtension(resourceGroupName, vmName, extensionName, publisherName, version, options, serviceClients, __cb(_, __frame, 22, 9, function __$setExtension__24() { _(); }, true)); }); }, true)); }); },


  setChefExtension: function setChefExtension__25(resourceGroupName, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, extensionName, vmImage, versionsResult, versions, ver, __this = this; var __frame = { name: "setChefExtension__25", line: 982 }; return __func(_, this, arguments, setChefExtension__25, 3, __frame, function __$setChefExtension__25() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription); return (function __$setChefExtension__25(__then) {

        if ((!options.clientPem && !options.validationPem)) {
          return __this.cli.interaction.promptIfNotGiven($("VM Extension validation pem file path: "), options.validationPem, __cb(_, __frame, 5, 51, function ___(__0, __1) { options.validationPem = __1; __then(); }, true)); } else { __then(); } ; })(function __$setChefExtension__25() { return (function __$setChefExtension__25(__then) {


          if (!options.clientConfig) {
            return __this.cli.interaction.promptIfNotGiven($("Chef client config file(i.e client.rb) path: "), options.clientConfig, __cb(_, __frame, 9, 50, function ___(__0, __2) { options.clientConfig = __2; __then(); }, true)); } else { __then(); } ; })(function __$setChefExtension__25() {
          ...
          return virtualMachine.getVM(resourceGroupName, vmName, __cb(_, __frame, 13, 34, function ___(__0, __3) { vmResult = __3;
            ...
            if ((virtualMachine.storageProfile.osDisk.osType === "Windows")) {
              ...
              extensionName = "LinuxChefClient"; } ; return (function __$setChefExtension__25(__then) {


              if (options.uninstall) {
                return __this._uninstallExtension(resourceGroupName, vmName, extensionName, serviceClients, options, __cb(_, __frame, 33, 11, function __$setChefExtension__25() { return _(null); }, true)); } else { __then(); } ; })(function __$setChefExtension__25() { return (function __$setChefExtension__25(__then) {
                ...
                if (!options.version) {
                  ...
                  return vmImage.getVMExtensionImageVersionList(options.location, CHEFPUBLISHER, extensionName, __cb(_, __frame, 40, 35, function ___(__0, __4) { versionsResult = __4;
                    ...
                    options.version = ((ver[0] + ".") + ver[1]); __then(); }, true)); } else { __then(); } ; })(function __$setChefExtension__25() {
                ...
                pubConfig["deleteChefConfig"] = (options.deleteChefConfig ? "true" : "false"); return (function __$setChefExtension__25(__then) {
                  if (options.bootstrapOptions) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$setChefExtension__25() {

                          pubConfig["bootstrap_options"] = JSON.parse(options.bootstrapOptions); __then(); }); })(function ___(er, __result) { __catch(function __$setChefExtension__25() { if (er) {

                            log.error("Bad user input for -j or --bootstrap-options option", er);
                            return _(null, cb(er)); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(function __$setChefExtension__25() {
                  ...
                  return __this._createOrUpdateExtension(resourceGroupName, vmName, extensionName, CHEFPUBLISHER, options.version, options, serviceClients, __cb(_, __frame, 72, 9, function __$setChefExtension__25() { _(); }, true)); }); }); }); }, true)); }); }); }); },



  getExtensions: function getExtensions__26(resourceGroup, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, output, __this = this; var __frame = { name: "getExtensions__26", line: 1058 }; return __func(_, this, arguments, getExtensions__26, 3, __frame, function __$getExtensions__26() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  getChefExtension: function getChefExtension__27(resourceGroup, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, output, __this = this; var __frame = { name: "getChefExtension__27", line: 1089 }; return __func(_, this, arguments, getChefExtension__27, 3, __frame, function __$getChefExtension__27() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  createDockerVM: function createDockerVM__28(resourceGroupName, vmName, location, osType, options, _) { var subscription, serviceClients, dockerExtensionParams, vmExtensionProfile, dockerExtension, virtualMachine, __this = this; var __frame = { name: "createDockerVM__28", line: 1124 }; return __func(_, this, arguments, createDockerVM__28, 5, __frame, function __$createDockerVM__28() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return vmExtensionProfile.generateDockerExtensionProfile(__cb(_, __frame, 13, 45, function ___(__0, __1) { dockerExtension = __1;
        ...
        return __this.createVM(resourceGroupName, vmName, location, osType, options, __cb(_, __frame, 15, 9, function __$createDockerVM__28() {
          virtualMachine = new VirtualMachine(__this.cli, serviceClients); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createDockerVM__28() {

                return virtualMachine.createOrUpdateVMExtension(resourceGroupName, vmName, dockerExtension.profile, true, __cb(_, __frame, 18, 21, __then, true)); }); })(function ___(e, __result) { __catch(function __$createDockerVM__28() { if (e) {

                  return virtualMachine.deleteVM(resourceGroupName, vmName, __cb(_, __frame, 20, 21, function __$createDockerVM__28() {
                    return _(e); }, true)); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$createDockerVM__28() { _(); }); }); }, true)); }, true)); }); },



  listVMImagePublishers: function listVMImagePublishers__29(location, options, _) { var subscription, serviceClients, vmImage, publishersResult, publishers, output, __this = this; var __frame = { name: "listVMImagePublishers__29", line: 1149 }; return __func(_, this, arguments, listVMImagePublishers__29, 2, __frame, function __$listVMImagePublishers__29() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImageOffers: function listVMImageOffers__30(location, publisherName, options, _) { var subscription, serviceClients, vmImage, offersResult, offers, output, __this = this; var __frame = { name: "listVMImageOffers__30", line: 1176 }; return __func(_, this, arguments, listVMImageOffers__30, 3, __frame, function __$listVMImageOffers__30() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImageSkus: function listVMImageSkus__31(location, publisherName, offer, options, _) { var subscription, serviceClients, vmImage, skuResult, skus, output, __this = this; var __frame = { name: "listVMImageSkus__31", line: 1204 }; return __func(_, this, arguments, listVMImageSkus__31, 4, __frame, function __$listVMImageSkus__31() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImages: function listVMImages__32(params, options, _) { var subscription, serviceClients, imageFilter, vmImage, imagesResult, images, output, __this = this; var __frame = { name: "listVMImages__32", line: 1233 }; return __func(_, this, arguments, listVMImages__32, 2, __frame, function __$listVMImages__32() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      imageFilter = {
  ...
  getVMImageDetails: function getVMImageDetails__33(params, options, _) { var subscription, serviceClients, imageFilter, vmImage, imagesResult, images, output, __this = this; var __frame = { name: "getVMImageDetails__33", line: 1270 }; return __func(_, this, arguments, getVMImageDetails__33, 2, __frame, function __$getVMImageDetails__33() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      imageFilter = {
        location: params.location,
      ...
      return vmImage.getVMImageDetails(imageFilter, __cb(_, __frame, 12, 31, function ___(__0, __1) { imagesResult = __1;
        ...
        if ((!images || (images.length === 0))) {
          ...
          output.json(images); } ; _(); }, true)); }); },



  listVMExtensionImageTypes: function listVMExtensionImageTypes__34(location, publisherName, options, _) { var subscription, serviceClients, vmImage, typesResult, types, output, __this = this; var __frame = { name: "listVMExtensionImageTypes__34", line: 1293 }; return __func(_, this, arguments, listVMExtensionImageTypes__34, 3, __frame, function __$listVMExtensionImageTypes__34() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMExtensionImageVersions: function listVMExtensionImageVersions__35(location, publisherName, typeName, options, _) { var subscription, serviceClients, vmImage, versionsResult, versions, output, __this = this; var __frame = { name: "listVMExtensionImageVersions__35", line: 1321 }; return __func(_, this, arguments, listVMExtensionImageVersions__35, 4, __frame, function __$listVMExtensionImageVersions__35() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMExtensionImages: function listVMExtensionImages__36(location, publisher, typeName, options, _) { var subscription, serviceClients, vmImageClient, extImagesResult, extImages, output, __this = this; var __frame = { name: "listVMExtensionImages__36", line: 1350 }; return __func(_, this, arguments, listVMExtensionImages__36, 4, __frame, function __$listVMExtensionImages__36() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  getVMExtensionImage: function getVMExtensionImage__37(location, publisherName, typeName, version, options, _) { var subscription, serviceClients, vmImage, imageResult, output, __this = this; var __frame = { name: "getVMExtensionImage__37", line: 1378 }; return __func(_, this, arguments, getVMExtensionImage__37, 5, __frame, function __$getVMExtensionImage__37() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  _createOrUpdateExtension: function _createOrUpdateExtension__38(resourceGroupName, vmName, extensionName, publisherName, version, options, serviceClients, _) { var vMExtensionProfile, vmExtension, virtualMachine, __this = this; var __frame = { name: "_createOrUpdateExtension__38", line: 1400 }; return __func(_, this, arguments, _createOrUpdateExtension__38, 7, __frame, function __$_createOrUpdateExtension__38() {
      ...
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      return virtualMachine.createOrUpdateVMExtension(resourceGroupName, vmName, vmExtension.profile, true, __cb(_, __frame, 9, 19, function __$_createOrUpdateExtension__38() { _(); }, true)); }); },


  _uninstallExtension: function _uninstallExtension__39(resourceGroupName, vmName, extensionName, serviceClients, options, _) { var virtualMachine, extension, __this = this; var __frame = { name: "_uninstallExtension__39", line: 1412 }; return __func(_, this, arguments, _uninstallExtension__39, 5, __frame, function __$_uninstallExtension__39() {
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      return virtualMachine.getVMExtension(resourceGroupName, vmName, extensionName, __cb(_, __frame, 2, 35, function ___(__0, __2) { extension = __2;
        if (!extension) {
          return _(new Error(util.format($("Extension \"%s\" not found under the virtual machine \"%s\""), extensionName, vmName))); } ; return (function __$_uninstallExtension__39(_) {


          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm(util.format($("Uninstall the virtual machine extension \"%s\"? [y/n] "), extensionName), __cb(_, __frame, 7, 48, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -1411, 17, function ___(__0, __3) { return (function __$_uninstallExtension__39(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$_uninstallExtension__39() {



            return virtualMachine.deleteVMExtension(resourceGroupName, vmName, extensionName, __cb(_, __frame, 11, 19, function __$_uninstallExtension__39() { _(); }, true)); }); }, true)); }, true)); }); },


  _populateNics: function _populateNics__40(virtualMachine, subscription, _) { var networkInterfaces, networkResourceProviderClient, networkNic, networkPublicIP, i, networkInterface, nicInfo, ipConfigurations, ipConfiguration, pubIPInfo, __this = this; var __frame = { name: "_populateNics__40", line: 1426 }; return __func(_, this, arguments, _populateNics__40, 2, __frame, function __$_populateNics__40() {
      ...
      networkInterfaces = virtualMachine.networkProfile.networkInterfaces; return (function __$_populateNics__40(__then) {
        if ((networkInterfaces.length > 0)) {
          ...
          i = 0; var __4 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$_populateNics__40() { __more = false; if (__4) { i++; } else { __4 = true; } ; var __3 = (i < networkInterfaces.length); if (__3) {
                networkInterface = networkInterfaces[i];
                return networkNic.getNICInfoById(networkInterface.id, __cb(_, __frame, 12, 33, function ___(__0, __1) { nicInfo = __1; return (function __$_populateNics__40(__then) {
                    if (nicInfo.profile) {
                      networkInterface.expanded = nicInfo.profile;
                      ipConfigurations = networkInterface.expanded.ipConfigurations; return (function __$_populateNics__40(__then) {
                        if ((ipConfigurations && (ipConfigurations.length > 0))) {

                          ipConfiguration = ipConfigurations[0]; return (function __$_populateNics__40(__then) {
                            if ((ipConfiguration.publicIpAddress && ipConfiguration.publicIpAddress.id)) {
                              return networkPublicIP.getPublicIPInfoById(ipConfiguration.publicIpAddress.id, __cb(_, __frame, 20, 46, function ___(__0, __2) { pubIPInfo = __2;
                                if (pubIPInfo.profile) {
                                  ipConfiguration.publicIpAddress.expanded = pubIPInfo.profile; } ; __then(); }, true)); } else { __then(); } ; })(__then); } else { __then(); } ; })(__then); } else { __then(); } ; })(function __$_populateNics__40() { while (__more) { __loop(); }; __more = true; }); }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(__then); } else { __then(); } ; })(function __$_populateNics__40() {
  ...
  setAzureDiskEncryption: function setAzureDiskEncryption__41(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, params, vmResult, vmExtensionProfile, azureDiskEncryptionExtension, result, extensionName, publisherName, getOptions, extensionResult, statusUrl, vmModel, encryptionSettings, __this = this; var __frame = { name: "setAzureDiskEncryption__41", line: 1506 }; return __func(_, this, arguments, setAzureDiskEncryption__41, 3, __frame, function __$setAzureDiskEncryption__41() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      params = { };
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 6, 34, function ___(__0, __2) { vmResult = __2;
        ...
        azureDiskEncryptionExtension = vmExtensionProfile.generateAzureDiskEncryptionExtensionProfile(); return (function __$setAzureDiskEncryption__41(_) {

          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ;
          return __this.cli.interaction.confirm($("This cmdlet prepares the VM and enables encryption which may reboot the machine and takes 10-15 minutes to finish. Please save your work on the VM before confirming. Do you want to continue? [y/n] "), __cb(_, __frame, 30, 30, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -1505, 17, function ___(__0, __3) { return (function __$setAzureDiskEncryption__41(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$setAzureDiskEncryption__41() {
            ...
            return virtualMachine.createOrUpdateVMExtension(resourceGroupName, name, azureDiskEncryptionExtension.profile, true, __cb(_, __frame, 35, 32, function ___(__0, __4) { result = __4;
              ...
              return serviceClients.computeManagementClient.virtualMachineExtensions.get(resourceGroupName, name, extensionName, getOptions, __cb(_, __frame, 55, 90, function ___(__0, __5) { extensionResult = __5;
                ...
                return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 74, 33, function ___(__0, __6) { vmModel = __6;
                  ...
                  return virtualMachine.createOrUpdateVM(resourceGroupName, vmModel, false, __cb(_, __frame, 102, 26, _, true)); }, true)); }, true)); }, true)); }); }, true)); }, true)); }); },


  showAzureDiskEncryptionStatus: function showAzureDiskEncryptionStatus__42(resourceGroupName, name, options, _) { var subscription, serviceClients, virtualMachine, output, encryptionStatus, extensionStatus, vmModel, extensionName, publisherName, getOptions, isJson, string, __this = this; var __frame = { name: "showAzureDiskEncryptionStatus__42", line: 1611 }; return __func(_, this, arguments, showAzureDiskEncryptionStatus__42, 3, __frame, function __$showAzureDiskEncryptionStatus__42() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      output = __this.cli.output;
      ...
      return virtualMachine.getVM(resourceGroupName, name, __cb(_, __frame, 12, 33, function ___(__0, __1) { vmModel = __1;
        if (!vmModel) {
          return _(new Error(util.format($("Virtual machine \"%s\" not found under the resource group \"%s\""), name, resourceGroupName))); } ; return (function __$showAzureDiskEncryptionStatus__42(__then) {
          ...
          if (vmModel.storageProfile.osDisk.encryptionSettings) {
            ...
            if (utils.ignoreCaseEquals(vmModel.storageProfile.osDisk.osType, "Linux")) {
              ...
              if (utils.ignoreCaseEquals(vmModel.storageProfile.osDisk.osType, "Windows")) {
                extensionName = vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_NAME;
                publisherName = vmConstants.EXTENSIONS.AZURE_DISK_ENCRYPTION_WINDOWS_EXTENSION_PUBLISHER; } ; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$showAzureDiskEncryptionStatus__42() {



                  getOptions = { expand: "instanceView" };
                  return serviceClients.computeManagementClient.virtualMachineExtensions.get(resourceGroupName, name, extensionName, getOptions, __cb(_, __frame, 39, 90, function ___(__0, __2) { extensionStatus = __2; __then(); }, true)); }); })(function ___(e, __result) { __catch(function __$showAzureDiskEncryptionStatus__42() { if (e) {


                    extensionStatus = null; __then(); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$showAzureDiskEncryptionStatus__42() {
                ...
                if (((((extensionStatus) && utils.ignoreCaseEquals(extensionStatus.publisher, publisherName)) && utils.ignoreCaseEquals(extensionStatus.virtualMachineExtensionType, extensionName)) && utils.ignoreCaseEquals(extensionStatus.provisioningState, vmConstants.EXTENSIONS.EXTENSION_PROVISIONING_SUCCEEDED))) {
                  ...
                  if ((((!extensionStatus.settings.VolumeType || utils.ignoreCaseEquals(extensionStatus.settings.VolumeType, "All")) || utils.ignoreCaseEquals(extensionStatus.settings.VolumeType, "Data")) || (utils.stringIsNullOrEmpty(extensionStatus.settings.VolumeType)))) {
                    ...
                    encryptionStatus.dataVolumesEncrypted = true; } ; } ; __then(); }); }); } else { __then(); } ; })(function __$showAzureDiskEncryptionStatus__42() {
