...
exports.init = function initApiAppCommands(cli) {
  ...
  apiapp.command("list [resource-group]").description($("List currently deployed ApiApps in a subscription or resource group")).option("-g --resource-group <resource-group>", $("the resource group name, if not given list all ApiApps in subscription")).option("-s --subscription <subscription>", $("The subscription identifier")).option("-d --detailed", $("Include ApiApp package version and auth setting (call will be slower)")).execute(function __1(resourceGroup, options, _) { var subscription, client, resourceClient, apiApps; var __frame = { name: "__1", line: 43 }; return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
      ...
      return cli.interaction.withProgress($("Listing ApiApps"), function __1(log, _) { var groups; var __frame = { name: "__1", line: 51 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
          ...
          groups = []; return (function __$__1(__then) {
            ...
            return groups.map_(__cb(_, __frame, 8, 35, function ___(__0, __4) { var __3 = __.flatten(__4); return _(null, __3); }, true), function __1(_, group) { var __frame = { name: "__1", line: 59 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
                return azureSdkStream.toArray(client.apiApps.listStream(group, (options.detailed ? "detail" : "basic")), __cb(_, __frame, 1, 34, _, true)); }); }); }); }); }, __cb(_, __frame, 7, 36, function ___(__0, __2) { apiApps = __2;
  ...
  apiapp.command("show [resource-group] [name]").description($("Get detailed information about a deployed ApiApp")).option("-g --resource-group <resource-group>", $("Name of the resource group containing the ApiApp")).option("-n --name <name>", $("Name of the ApiApp")).option("-s --subscription <subscription>", $("The subscription identifier")).execute(function __2(resourceGroup, name, options, _) { var subscription, client, response, apiAppReportFormat; var __frame = { name: "__2", line: 88 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
      ...
      client = createApiAppClient(subscription);
      return cli.interaction.withProgress($("Getting ApiApp"), function __1(log, _) { var __frame = { name: "__1", line: 95 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

          return client.apiApps.get(resourceGroup, name, __cb(_, __frame, 1, 32, _, true)); }); }, __cb(_, __frame, 6, 37, function ___(__0, __2) { response = __2;
  ...
  apiapp.command("create [resource-group] [name] [plan]").description($("Create a new ApiApp instance")).option("-n --name <name>", $("Name of the ApiApp instance")).option("-g --resource-group <resource-group>", $("Name of the resource group")).option("-p --plan <plan>", $("Name or Resource Id of the App Service Plan to use")).option("-u --nuget-package <package>", $("Package name and version to deploy (optional)")).option("--parameters <parameters>", $("A JSON-formatted string containing parameters")).option("--parameters-file <parametersFile>", $("A file containing parameters in JSON format")).option("-s --subscription <subscription>", $("The subscription identifier")).option("--nowait", $("Do not wait for the deployment to complete")).execute(function __3(resourceGroup, name, plan, options, _) { var normalizedParameters, message, subscription, packageInfo, resourceClient, prompter, deployer, deployment, finalResult; var __frame = { name: "__3", line: 126 }; return __func(_, this, arguments, __3, 4, __frame, function __$__3() {
      ...
      return cli.interaction.withProgress($("Checking resource group and app service plan"), function __1(log, _) { var hostingPlanResource; var __frame = { name: "__1", line: 164 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
          ...
          return resourceClient.resourceGroups.checkExistence(options.resourceGroup, __cb(_, __frame, 2, 45, function ___(__0, __2) { var __1 = !__2; return (function __$__1(__then) { if (__1) {
              ...
              return getHostingPlanResource(resourceClient, options.resourceGroup, options.plan, __cb(_, __frame, 6, 36, function ___(__0, __3) { hostingPlanResource = __3;
                ...
                options.plan = hostingPlanResource.id; _(); }, true)); }); }, true)); }); }, __cb(_, __frame, 37, 22, function __$__3() { return (function __$__3(_) { return (function __$__3(_) {



            var __4 = objectPrompter(options); if (__4) { return _(null, __4); } ;
            return filePrompter(options, __cb(_, __frame, 55, 8, _, true)); })(__cb(_, __frame, -125, 17, function ___(__0, __3) { var __5 = __3; return (function __$__3(__then) { if (__5) { var __6 = __3; return _(null, __6); } else { __then(); } ; })(function __$__3() {
              return _(null, interactivePrompter(options, cli.interaction)); }); }, true)); })(__cb(_, __frame, -125, 17, function ___(__0, __4) { prompter = __4;
          ...
          return deployer.doDeployment(__cb(_, __frame, 70, 32, function ___(__0, __5) { deployment = __5; return (function __$__3(__then) {

              if (!options.noWait) {
                return cli.interaction.withProgress($("Waiting for deployment completion"), function __2(l, _) { var progress, finalResult, tracker, __this = this; var __frame = { name: "__2", line: 200 }; return __func(_, this, arguments, __2, 1, __frame, function __$__2() { progress = __this;
                    ...
                    return waitForDeploymentDone(tracker, __cb(_, __frame, 50, 42, function ___(__0, __1) { finalResult.finalDeployment = __1;
                      return _(null, finalResult); }, true)); }); }, __cb(_, __frame, 73, 42, function ___(__0, __6) { finalResult = __6;
...
function filePrompter(options, _) { var buffer, parameterValues; var __frame = { name: "filePrompter", line: 320 }; return __func(_, this, arguments, filePrompter, 1, __frame, function __$filePrompter() { return (function __$filePrompter(__then) {
...
function getHostingPlanResource(client, resourceGroup, planId, _) { var planName, idRe, match, response; var __frame = { name: "getHostingPlanResource", line: 345 }; return __func(_, this, arguments, getHostingPlanResource, 3, __frame, function __$getHostingPlanResource() {
...
function showDeprecateMessage(log) {
  if (!log.format().json) {
    log.warn(("With the shutdown of V1 service, Api App commands will be removed " + "in a future release of azure-cli.")); } ;};
