...
exports.init = function(cli) {
  ...
  rediscache.command("show [name] [resource-group]").description($("Show properties of an existing Redis Cache")).usage("[--name <name> --resource-group <resource-group>]").option("-n, --name <name>", $("Name of the Redis Cache.")).option("-g, --resource-group <resource-group>", $("Name of the Resource Group")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(name, resourceGroup, options, _) { var subscription, client, operation, progress, result; var __frame = { name: "__4", line: 366 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
      ...
      operation = null; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() {
            ...
            return client.redis.get(options.resourceGroup, options.name, __cb(_, __frame, 29, 31, function ___(__0, __1) { operation = __1; __then(); }, true)); }); })(function ___(e, __result) { __catch(function __$__4() { if (e) {
  ...
  rediscache.command("set [name] [resource-group]").description($("Change settings of an existing Redis Cache")).usage("[--name <name> --resource-group <resource-group> --redis-configuration <redis-configuration>/--redis-configuration-file <redisConfigurationFile>]").option("-n, --name <name>", $("Name of the Redis Cache.")).option("-g, --resource-group <resource-group>", $("Name of the Resource Group")).option("-c, --redis-configuration <redis-configuration>", $("Redis Configuration. Enter a JSON formatted string of configuration keys and values here.")).fileRelatedOption("-f, --redis-configuration-file <redisConfigurationFile>", $("Redis Configuration. Enter the path of a file containing configuration keys and values here.")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(name, resourceGroup, options, _) { var subscription, client, progress, operation, result, redisConfigurationHashTable, parameters, updateProgress, updateResult; var __frame = { name: "__5", line: 456 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
  ...
  rediscache.command("renew-key [name] [resource-group]").description($("Renew the authentication key for an existing Redis Cache")).usage("[--name <name> --resource-group <resource-group> ]").option("-n, --name <name>", $("Name of the Redis Cache.")).option("-g, --resource-group <resource-group>", $("Name of the Resource Group under which cache exists")).option("-t, --key-type <key-type>", $("type of key to renew. Valid values are: 'Primary', 'Secondary'.")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __6(name, resourceGroup, options, _) { var subscription, client, SeeIfCacheExists, progress, callbackArgs, result, response; var __frame = { name: "__6", line: 571 }; return __func(_, this, arguments, __6, 3, __frame, function __$__6() {
