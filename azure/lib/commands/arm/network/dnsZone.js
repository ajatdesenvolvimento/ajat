...
__.extend(DnsZone.prototype, {
  ...
  addRecord: function addRecord__18(resourceGroupName, zoneName, setName, options, _) { var self, dnsZone, existingSet, __this = this; var __frame = { name: "addRecord__18", line: 437 }; return __func(_, this, arguments, addRecord__18, 4, __frame, function __$addRecord__18() { self = __this;
  ...
  deleteRecord: function deleteRecord__19(resourceGroupName, zoneName, setName, options, _) { var self, existingSet, __this = this; var __frame = { name: "deleteRecord__19", line: 458 }; return __func(_, this, arguments, deleteRecord__19, 4, __frame, function __$deleteRecord__19() { self = __this;
  ...
  updateRecordSet: function updateRecordSet__20(resourceGroupName, zoneName, setName, setType, parameters, _) { var self, progress, recordSet, __this = this; var __frame = { name: "updateRecordSet__20", line: 477 }; return __func(_, this, arguments, updateRecordSet__20, 5, __frame, function __$updateRecordSet__20() { self = __this;
  ...
  promptRecordParameters: function promptRecordParameters__21(type, options, _) { var self, lowerType, __this = this; var __frame = { name: "promptRecordParameters__21", line: 493 }; return __func(_, this, arguments, promptRecordParameters__21, 2, __frame, function __$promptRecordParameters__21() { self = __this;
