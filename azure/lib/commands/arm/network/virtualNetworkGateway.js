...
__.extend(VirtualNetworkGateway.prototype, {
          ...
          return self._parseGateway(resourceGroupName, parameters, options, __cb(_, __frame, 29, 22, function ___(__0, __3) { parameters = __3;
            ...
            return self.get(resourceGroupName, gatewayName, __cb(_, __frame, 31, 23, function ___(__0, __4) { gateway = __4;
              ...
              progress = self.interaction.progress(util.format($("Creating virtual network gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$create__1() {
                  ...
                  self._showGateway(gateway); _(); }); }); }, true)); }, true)); }); }); }); },
      ...
      return self.get(resourceGroupName, gatewayName, __cb(_, __frame, 2, 23, function ___(__0, __1) { gateway = __1;
        ...
        self.interaction.formatOutput(gateway, function(gateway) {
          if ((gateway === null)) {
            ...
            self._showGateway(gateway); } ; }); _(); }, true)); }); },




  delete: function delete__5(resourceGroupName, gatewayName, options, _) { var self, gateway, progress, __this = this; var __frame = { name: "delete__5", line: 149 }; return __func(_, this, arguments, delete__5, 3, __frame, function __$delete__5() { self = __this;
  ...
  get: function get__6(resourceGroupName, gatewayName, _) { var self, progress, gateway, __this = this; var __frame = { name: "get__6", line: 169 }; return __func(_, this, arguments, get__6, 2, __frame, function __$get__6() { self = __this;
  ...
  createConnection: function createConnection__7(resourceGroupName, connectionName, options, _) { var self, parameters, connection, progress, __this = this; var __frame = { name: "createConnection__7", line: 188 }; return __func(_, this, arguments, createConnection__7, 3, __frame, function __$createConnection__7() { self = __this;
      ...
      return self._parseConnection(resourceGroupName, parameters, options, true, __cb(_, __frame, 8, 22, function ___(__0, __1) { parameters = __1;
        ...
        return self.getConnection(resourceGroupName, connectionName, __cb(_, __frame, 10, 26, function ___(__0, __2) { connection = __2;
          ...
          progress = self.interaction.progress(util.format($("Creating gateway connection \"%s\" between \"%s\" and \"%s\""), connectionName, options.vnetGateway1, (options.vnetGateway2 || options.lnetGateway2))); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createConnection__7() {
              ...
              self._showConnection(connection); _(); }); }); }, true)); }, true)); }); },


  setConnection: function setConnection__8(resourceGroupName, connectionName, options, _) { var self, connection, progress, __this = this; var __frame = { name: "setConnection__8", line: 212 }; return __func(_, this, arguments, setConnection__8, 3, __frame, function __$setConnection__8() { self = __this;
  ...
  listConnections: function listConnections__9(resourceGroupName, options, _) { var self, progress, connections, __this = this; var __frame = { name: "listConnections__9", line: 231 }; return __func(_, this, arguments, listConnections__9, 2, __frame, function __$listConnections__9() { self = __this;
  ...
  showConnection: function showConnection__10(resourceGroupName, connectionName, options, _) { var self, connection, __this = this; var __frame = { name: "showConnection__10", line: 267 }; return __func(_, this, arguments, showConnection__10, 3, __frame, function __$showConnection__10() { self = __this;
      ...
      return self.getConnection(resourceGroupName, connectionName, __cb(_, __frame, 2, 26, function ___(__0, __1) { connection = __1;
        ...
        self.interaction.formatOutput(connection, function(connection) {
          if ((connection === null)) {
            ...
            self._showConnection(connection); } ; }); _(); }, true)); }); },




  deleteConnection: function deleteConnection__11(resourceGroupName, connectionName, options, _) { var self, connection, progress, __this = this; var __frame = { name: "deleteConnection__11", line: 280 }; return __func(_, this, arguments, deleteConnection__11, 3, __frame, function __$deleteConnection__11() { self = __this;
      ...
      return self.getConnection(resourceGroupName, connectionName, __cb(_, __frame, 2, 26, function ___(__0, __2) { connection = __2;
        ...
        if (!connection) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete gateway connection \"%s\"? [y/n] "), connectionName), __cb(_, __frame, 8, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -279, 17, function ___(__0, __3) { return (function __$deleteConnection__11(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$deleteConnection__11() {
  ...
  getConnection: function getConnection__12(resourceGroupName, connectionName, _) { var self, progress, connection, __this = this; var __frame = { name: "getConnection__12", line: 300 }; return __func(_, this, arguments, getConnection__12, 2, __frame, function __$getConnection__12() { self = __this;
  ...
  showConnectionSharedKey: function showConnectionSharedKey__15(resourceGroupName, connectionName, options, _) { var self, connection, sharedKey, __this = this; var __frame = { name: "showConnectionSharedKey__15", line: 359 }; return __func(_, this, arguments, showConnectionSharedKey__15, 3, __frame, function __$showConnectionSharedKey__15() { self = __this;
  ...
  getConnectionSharedKey: function getConnectionSharedKey__16(resourceGroupName, connectionName, _) { var self, progress, sharedKey, __this = this; var __frame = { name: "getConnectionSharedKey__16", line: 377 }; return __func(_, this, arguments, getConnectionSharedKey__16, 2, __frame, function __$getConnectionSharedKey__16() { self = __this;
  ...
  _parseGateway: function _parseGateway__17(resourceGroupName, gateway, options, _) { var self, ipValidationResult, publicip, subnet, __this = this; var __frame = { name: "_parseGateway__17", line: 397 }; return __func(_, this, arguments, _parseGateway__17, 3, __frame, function __$_parseGateway__17() { self = __this;
  ...
  _parseConnection: function _parseConnection__18(resourceGroupName, connection, options, useDefaults, _) { var self, defType, weight, defWeight, resGroupGateway1, gateway1, resGroupGateway2, gateway2, resGroupLnetGateway2, lnet2, __this = this; var __frame = { name: "_parseConnection__18", line: 462 }; return __func(_, this, arguments, _parseConnection__18, 4, __frame, function __$_parseConnection__18() { self = __this;
