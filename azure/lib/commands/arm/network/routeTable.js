...
__.extend(RouteTable.prototype, {
  ...
  create: function create__1(resourceGroupName, routeTableName, options, _) { var self, parameters, routeTable, progress, __this = this; var __frame = { name: "create__1", line: 36 }; return __func(_, this, arguments, create__1, 3, __frame, function __$create__1() { self = __this;
      ...
      return self.get(resourceGroupName, routeTableName, __cb(_, __frame, 9, 26, function ___(__0, __1) { routeTable = __1;
        ...
        progress = self.interaction.progress(util.format($("Creating Route Table \"%s\""), routeTableName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$create__1() {
            ...
            self._showRouteTable(routeTable); _(); }); }); }, true)); }); },
  ...
  createRoute: function createRoute__7(resourceGroupName, routeTableName, routeName, options, _) { var self, parameters, routeTable, route, progress, __this = this; var __frame = { name: "createRoute__7", line: 162 }; return __func(_, this, arguments, createRoute__7, 4, __frame, function __$createRoute__7() { self = __this;
      ...
      return self.get(resourceGroupName, routeTableName, __cb(_, __frame, 7, 26, function ___(__0, __1) { routeTable = __1;
        if (!routeTable) {
          return _(new Error(util.format($("A Route Table with name \"%s\" not found in the resource group \"%s\""), routeTableName, resourceGroupName))); } ;


        return self.getRoute(resourceGroupName, routeTableName, routeName, __cb(_, __frame, 12, 21, function ___(__0, __2) { route = __2;
          if (route) {
          ...
          progress = self.interaction.progress(util.format($("Creating route \"%s\" in a route table \"%s\""), routeName, routeTableName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createRoute__7() {
                ...
                return self.networkManagementClient.routes.createOrUpdate(resourceGroupName, routeTableName, routeName, parameters, __cb(_, __frame, 19, 50, function ___(__0, __3) { route = __3; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$createRoute__7() {
              ...
              self._showRoute(route); _(); }); }); }, true)); }, true)); }); },


  setRoute: function setRoute__8(resourceGroupName, routeTableName, routeName, options, _) { var self, routeTable, route, progress, __this = this; var __frame = { name: "setRoute__8", line: 188 }; return __func(_, this, arguments, setRoute__8, 4, __frame, function __$setRoute__8() { self = __this;
  ...
  listRoutes: function listRoutes__9(resourceGroupName, routeTableName, options, _) { var self, routeTable, progress, routes, __this = this; var __frame = { name: "listRoutes__9", line: 212 }; return __func(_, this, arguments, listRoutes__9, 3, __frame, function __$listRoutes__9() { self = __this;
  ...
  showRoute: function showRoute__10(resourceGroupName, routeTableName, routeName, options, _) { var self, routeTable, route, __this = this; var __frame = { name: "showRoute__10", line: 243 }; return __func(_, this, arguments, showRoute__10, 4, __frame, function __$showRoute__10() { self = __this;
  ...
  deleteRoute: function deleteRoute__11(resourceGroupName, routeTableName, routeName, options, _) { var self, routeTable, route, progress, __this = this; var __frame = { name: "deleteRoute__11", line: 262 }; return __func(_, this, arguments, deleteRoute__11, 4, __frame, function __$deleteRoute__11() { self = __this;
      ...
      return self.get(resourceGroupName, routeTableName, __cb(_, __frame, 3, 26, function ___(__0, __2) { routeTable = __2;
        ...
        return self.getRoute(resourceGroupName, routeTableName, routeName, __cb(_, __frame, 8, 21, function ___(__0, __3) { route = __3;
          if (!route) {
            ...
            var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete route \"%s\"? [y/n] "), routeName), __cb(_, __frame, 13, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -261, 17, function ___(__0, __4) { return (function __$deleteRoute__11(__then) { if (__4) { return _(null); } else { __then(); } ; })(function __$deleteRoute__11() {
  ...
  getRoute: function getRoute__12(resourceGroupName, routeTableName, routeName, _) { var self, progress, route, __this = this; var __frame = { name: "getRoute__12", line: 287 }; return __func(_, this, arguments, getRoute__12, 3, __frame, function __$getRoute__12() { self = __this;
