...
__.extend(PublicIp.prototype, {
  ...
  create: function create__1(resourceGroupName, publicIpName, options, _) { var self, parameters, publicIp, progress, __this = this; var __frame = { name: "create__1", line: 34 }; return __func(_, this, arguments, create__1, 3, __frame, function __$create__1() { self = __this;
      ...
      return self.get(resourceGroupName, publicIpName, __cb(_, __frame, 10, 24, function ___(__0, __1) { publicIp = __1;
        ...
        progress = self.interaction.progress(util.format($("Creating public ip address \"%s\""), publicIpName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$create__1() {
            ...
            self._showPublicIP(publicIp); _(); }); }); }, true)); }); },
  ...
  delete: function delete__4(resourceGroupName, publicIpName, options, _) { var self, publicIp, progress, __this = this; var __frame = { name: "delete__4", line: 91 }; return __func(_, this, arguments, delete__4, 3, __frame, function __$delete__4() { self = __this;
      ...
      return self.get(resourceGroupName, publicIpName, __cb(_, __frame, 3, 24, function ___(__0, __2) { publicIp = __2;
        if (!publicIp) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete public ip address \"%s\"? [y/n] "), publicIpName), __cb(_, __frame, 8, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -90, 17, function ___(__0, __3) { return (function __$delete__4(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$delete__4() {
  ...
  list: function list__5(options, _) { var self, publicIPs, progress, __this = this; var __frame = { name: "list__5", line: 111 }; return __func(_, this, arguments, list__5, 1, __frame, function __$list__5() { self = __this;
  ...
  get: function get__6(resourceGroupName, publicIpName, _) { var self, progress, publicIP, __this = this; var __frame = { name: "get__6", line: 146 }; return __func(_, this, arguments, get__6, 2, __frame, function __$get__6() { self = __this;
