...
__.extend(Subnet.prototype, {
  ...
  create: function create__1(resourceGroupName, vnetName, subnetName, options, _) { var self, parameters, vnet, subnet, progress, __this = this; var __frame = { name: "create__1", line: 37 }; return __func(_, this, arguments, create__1, 4, __frame, function __$create__1() { self = __this;
      ...
      return self._parseSubnet(resourceGroupName, parameters, options, __cb(_, __frame, 5, 22, function ___(__0, __1) { parameters = __1;

        return self._getVNet(resourceGroupName, vnetName, __cb(_, __frame, 7, 20, function ___(__0, __2) { vnet = __2;
          if (!vnet) {
            return _(new Error(util.format($("Virtual network \"%s\" not found in resource group \"%s\""), vnetName, resourceGroupName))); } ;


          return self.get(resourceGroupName, vnetName, subnetName, __cb(_, __frame, 12, 22, function ___(__0, __3) { subnet = __3;
            if (subnet) {
            ...
            progress = self.interaction.progress(util.format($("Creating subnet \"%s\""), subnetName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$create__1() {
                  ...
                  return self.networkManagementClient.subnets.createOrUpdate(resourceGroupName, vnetName, subnetName, parameters, __cb(_, __frame, 19, 52, function ___(__0, __4) { subnet = __4; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$create__1() {
                ...
                self._showSubnet(subnet); _(); }); }); }, true)); }, true)); }, true)); }); },
        ...
        return self.get(resourceGroupName, vnetName, subnetName, __cb(_, __frame, 8, 22, function ___(__0, __2) { subnet = __2;
          self.interaction.formatOutput(subnet, function(subnet) {
            if ((subnet === null)) {
              ...
              self._showSubnet(subnet); } ; }); _(); }, true)); }, true)); }); },




  get: function get__5(resourceGroupName, vnetName, subnetName, _) { var self, progress, subnet, __this = this; var __frame = { name: "get__5", line: 134 }; return __func(_, this, arguments, get__5, 3, __frame, function __$get__5() { self = __this;
  ...
  delete: function delete__6(resourceGroupName, vnetName, subnetName, options, _) { var self, vnet, subnet, progress, __this = this; var __frame = { name: "delete__6", line: 150 }; return __func(_, this, arguments, delete__6, 4, __frame, function __$delete__6() { self = __this;
      ...
      return self._getVNet(resourceGroupName, vnetName, __cb(_, __frame, 3, 20, function ___(__0, __2) { vnet = __2;
        ...
        return self.get(resourceGroupName, vnetName, subnetName, __cb(_, __frame, 8, 22, function ___(__0, __3) { subnet = __3;
          if (!subnet) {
            ...
            var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete subnet \"%s\"? [y/n] "), subnetName), __cb(_, __frame, 13, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -149, 17, function ___(__0, __4) { return (function __$delete__6(__then) { if (__4) { return _(null); } else { __then(); } ; })(function __$delete__6() {
  ...
  _parseSubnet: function _parseSubnet__7(resourceGroupName, subnet, options, _) { var self, cidrValidation, nsg, routeTable, __this = this; var __frame = { name: "_parseSubnet__7", line: 178 }; return __func(_, this, arguments, _parseSubnet__7, 3, __frame, function __$_parseSubnet__7() { self = __this;
  ...
  _getVNet: function _getVNet__8(resourceGroupName, vnetName, _) { var self, progress, vnet, __this = this; var __frame = { name: "_getVNet__8", line: 253 }; return __func(_, this, arguments, _getVNet__8, 2, __frame, function __$_getVNet__8() { self = __this;
