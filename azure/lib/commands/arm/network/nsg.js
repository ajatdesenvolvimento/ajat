...
__.extend(Nsg.prototype, {
  ...
  create: function create__1(resourceGroupName, nsgName, location, options, _) { var self, nsg, progress, __this = this; var __frame = { name: "create__1", line: 36 }; return __func(_, this, arguments, create__1, 4, __frame, function __$create__1() { self = __this;
      ...
      return self.get(resourceGroupName, nsgName, __cb(_, __frame, 2, 19, function ___(__0, __1) { nsg = __1;
        ...
        progress = self.interaction.progress(util.format($("Creating a network security group \"%s\""), nsgName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$create__1() {
              ...
              return self.networkManagementClient.networkSecurityGroups.createOrUpdate(resourceGroupName, nsgName, nsg, __cb(_, __frame, 17, 63, function ___(__0, __2) { nsg = __2; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$create__1() {
            ...
            self._showSecurityGroup(nsg); _(); }); }); }, true)); }); },


  set: function set__2(resourceGroupName, nsgName, options, _) { var self, nsg, progress, __this = this; var __frame = { name: "set__2", line: 60 }; return __func(_, this, arguments, set__2, 3, __frame, function __$set__2() { self = __this;
  ...
  list: function list__3(options, _) { var self, groups, progress, __this = this; var __frame = { name: "list__3", line: 79 }; return __func(_, this, arguments, list__3, 1, __frame, function __$list__3() { self = __this;
  ...
  show: function show__4(resourceGroupName, nsgName, options, _) { var self, nsg, __this = this; var __frame = { name: "show__4", line: 111 }; return __func(_, this, arguments, show__4, 3, __frame, function __$show__4() { self = __this;
  ...
  delete: function delete__5(resourceGroupName, nsgName, options, _) { var self, nsg, progress, __this = this; var __frame = { name: "delete__5", line: 124 }; return __func(_, this, arguments, delete__5, 3, __frame, function __$delete__5() { self = __this;
  ...
  get: function get__6(resourceGroupName, nsgName, _) { var self, progress, nsg, __this = this; var __frame = { name: "get__6", line: 143 }; return __func(_, this, arguments, get__6, 2, __frame, function __$get__6() { self = __this;
  ...
  createRule: function createRule__7(resourceGroupName, nsgName, ruleName, options, _) { var self, parameters, nsg, rule, progress, __this = this; var __frame = { name: "createRule__7", line: 162 }; return __func(_, this, arguments, createRule__7, 4, __frame, function __$createRule__7() { self = __this;
  ...
  setRule: function setRule__8(resourceGroupName, nsgName, ruleName, options, _) { var self, nsg, rule, progress, __this = this; var __frame = { name: "setRule__8", line: 187 }; return __func(_, this, arguments, setRule__8, 4, __frame, function __$setRule__8() { self = __this;
  ...
  listRules: function listRules__9(resourceGroupName, nsgName, options, _) { var self, nsg, rules, __this = this; var __frame = { name: "listRules__9", line: 211 }; return __func(_, this, arguments, listRules__9, 3, __frame, function __$listRules__9() { self = __this;
  ...
  showRule: function showRule__10(resourceGroupName, nsgName, ruleName, options, _) { var self, nsg, rule, __this = this; var __frame = { name: "showRule__10", line: 229 }; return __func(_, this, arguments, showRule__10, 4, __frame, function __$showRule__10() { self = __this;
  ...
  deleteRule: function deleteRule__11(resourceGroupName, nsgName, ruleName, options, _) { var self, nsg, rule, progress, __this = this; var __frame = { name: "deleteRule__11", line: 251 }; return __func(_, this, arguments, deleteRule__11, 4, __frame, function __$deleteRule__11() { self = __this;
      ...
      return self.get(resourceGroupName, nsgName, __cb(_, __frame, 3, 19, function ___(__0, __2) { nsg = __2;
        ...
        return self.getRule(resourceGroupName, nsgName, ruleName, __cb(_, __frame, 8, 20, function ___(__0, __3) { rule = __3;
          if (!rule) {
            ...
            var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete network security rule \"%s\"? [y/n] "), ruleName), __cb(_, __frame, 13, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -250, 17, function ___(__0, __4) { return (function __$deleteRule__11(__then) { if (__4) { return _(null); } else { __then(); } ; })(function __$deleteRule__11() {
  ...
  getRule: function getRule__12(resourceGroupName, nsgName, ruleName, _) { var self, progress, rule, __this = this; var __frame = { name: "getRule__12", line: 276 }; return __func(_, this, arguments, getRule__12, 3, __frame, function __$getRule__12() { self = __this;
